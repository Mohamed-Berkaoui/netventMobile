  ...
  const renderIcon = () => {
    switch (name) {
      ...
      case "compass":
        return (
          <Svg width={size} height={size} viewBox="0 0 24 24" fill={color}>
            <Path fillRule="evenodd" d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25zM10.894 17.03a.75.75 0 01-.976-.073l-2.845-2.845a.75.75 0 01-.073-.976l3.546-5.318a.75.75 0 011.06-.082l2.773 2.772a.75.75 0 01.082 1.06l-3.567 5.462z" clipRule="evenodd" />
          </Svg>
        );
...
export function TabIcon({ name, focused, color, size = 22 }: { name: "home" | "calendar" | "compass" | "notifications" | "settings"; focused: boolean; color: string; size?: number }) {
